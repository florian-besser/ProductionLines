...
public class Square extends GameObject {
	...
	//private static final double TILE_GAP = 0.05;
	...
	protected void safeRender(GL2 gl) {
    	...
    	gl.glTexCoord2f(0, 0);
    	gl.glVertex3d(0+TILE_GAP, 0, 0+TILE_GAP);
    	gl.glTexCoord2f(1, 0);
    	gl.glVertex3d(0+1-TILE_GAP, 0, 0+TILE_GAP);
    	gl.glTexCoord2f(1, 1);
        gl.glVertex3d(0+1-TILE_GAP, 0, 0+1-TILE_GAP);
        gl.glTexCoord2f(0, 1);
        gl.glVertex3d(0+TILE_GAP, 0, 0+1-TILE_GAP);
